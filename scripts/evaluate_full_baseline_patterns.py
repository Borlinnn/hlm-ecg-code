#!/usr/bin/env python3
"""Evaluate full-lead baseline under required missing-lead patterns."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate full-lead baseline missing-pattern robustness.")
    ...
    parser.add_argument("--method-id", default="A0_full_no_masking")
