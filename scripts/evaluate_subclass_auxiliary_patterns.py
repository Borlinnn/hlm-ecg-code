#!/usr/bin/env python3
"""Evaluate A4a subclass auxiliary ablation under missing-lead patterns."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate subclass auxiliary ablation missing-pattern robustness.")
    ...
    parser.add_argument("--method-id", default="A4a_subclass_auxiliary")
