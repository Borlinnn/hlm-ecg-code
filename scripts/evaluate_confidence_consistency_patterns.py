#!/usr/bin/env python3
"""Evaluate A5 confidence consistency ablation under missing-lead patterns."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate confidence consistency ablation missing-pattern robustness.")
    ...
    parser.add_argument("--method-id", default="A5_confidence_consistency_0p10")
