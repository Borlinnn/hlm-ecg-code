#!/usr/bin/env python3
"""Evaluate the random lead dropout baseline under missing-lead patterns."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate random dropout baseline missing-pattern robustness.")
    ...
    parser.add_argument("--method-id", default="A1_random_dropout")
