#!/usr/bin/env python3
"""Evaluate the structured masking baseline under missing-lead patterns."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate structured masking baseline missing-pattern robustness.")
    ...
    parser.add_argument("--method-id", default="A2_structured_masking")
